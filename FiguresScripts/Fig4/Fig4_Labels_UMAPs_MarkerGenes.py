...
adata_query.obs["merged_type"] = adata_query.obs["merged_type"].cat.add_categories(['B_mem','DC','Macrophages','T_CD8+','T_CD4+_FH'])
adata_query.obs.loc[adata_query.obs["merged_type"].isin(['B_activated,4','B_activated,3','B_activated,0','B_activated,2','B_activated,1','B_mem','B_IFN']), "merged_type"] = 'B_mem'
...
B_TYPES = ["B_Cycling","B_GC_DZ","B_GC_LZ","B_mem","B_naive","B_plasma"]
B_TYPES = ["B_Cycling","B_GC_DZ","B_GC_LZ","B_mem"]
