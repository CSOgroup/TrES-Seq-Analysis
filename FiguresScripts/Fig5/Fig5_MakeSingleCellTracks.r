...
REGIONS <- list(
  SPRED1   = c("chr15", 38244999, 38364999),
  NRP1     = c("chr10", 33169999, 33344999),
  NEAT1    = c("chr11", 65416999, 65451999),
  EREG     = c("chr4",  74359999, 74393999),
  NFE2L2   = c("chr2",  177224999, 177269999),
  CD83     = c("chr6",  14111999, 14141999)
)
## Base sample definitions matching your actual filenames
sample_names <- c(
  "TrES H3K27ac - Untreated Macrophages",
  "TrES RNA - Untreated Macrophages",
  "TrES H3K27ac - CD47i Macrophages",
  "TrES RNA - CD47i Macrophages"
)

bam_files_fixed <- c(
  "./AC/Untreated__Macrophage__H3K27ac.bam",
  "./RNA/Untreated__Macrophage__RNA.bam",
  "./AC/CD47_Inhibitor__Macrophage__H3K27ac.bam",
  "./RNA/CD47_Inhibitor__Macrophage__RNA.bam"
)

sample_colors <- c(
  "TrES H3K27ac - Untreated Macrophages"  = "#3067B1",  # Blue (48, 103, 177)
  "TrES RNA - Untreated Macrophages"      = "#049948",  # Green (4, 153, 72)
  "TrES H3K27ac - CD47i Macrophages"  = "#3067B1",  # Blue (48, 103, 177)
  "TrES RNA - CD47i Macrophages"      = "#049948"  # Green (4, 153, 72)
)
