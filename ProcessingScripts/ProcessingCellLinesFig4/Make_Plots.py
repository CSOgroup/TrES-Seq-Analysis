...
if __name__ == "__main__":
    ...
    sample_list_RNA3 = ["Sc_CMr"]
    
    mod_list = ["H3K27ac","H3K27me3"]
    out_folder='/mnt/dataFast/ahrmad/triseq_2025052/processed'
    ...
    for sample in sample_list_DNA2:
        Tag_records_path = f'{out_folder}/Tag_Records_Sc_CMD.tsv'
    ...
    for sample in sample_list_RNA3:
        Tag_records_path = f'{out_folder}/Tag_Records_Sc_CMr.tsv'
        bam_file_path = f'{out_folder}/{sample}_ALL.bam'
        good_bc_path = f'{out_folder}/{sample}_ProperPairedMapped_reads_per_barcode.tsv'
        select_modality = "RNA"
